...
```
![Loading token](/images/posts/cancelling-react-state-updates/loading.png "Loading token")
...
![Effect function uses cancel in the outer scope](/images/posts/cancelling-react-state-updates/closure-1.png "Outer scope")
![Effect function uses cancel in its owns scope](/images/posts/cancelling-react-state-updates/closure-2.png "Inner scope")
</div>
...
![Fetch function uses reference to cancel boolean](/images/posts/cancelling-react-state-updates/closure-ref.png "Reference")
